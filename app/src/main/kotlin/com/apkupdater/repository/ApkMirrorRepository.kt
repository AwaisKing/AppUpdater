...
class ApkMirrorRepository(
    ...
    private fun parseUpdates(updates: List<AppExistsResponseData>, apps: List<AppInstalled>) = updates
    ...
    private fun filterWearOS(apk: AppExistsResponseApk): Boolean = !apk.capabilities?.contains("wear_standalone").orFalse()
