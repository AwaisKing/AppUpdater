...
fun About() = LazyColumn(
    ...
    item {
        Column(Modifier.padding(vertical = 16.dp)) {
            ...
            MediumText("${BuildConfig.VERSION_NAME} (${BuildConfig.VERSION_CODE}) fixes by AWAiS", Modifier.align(CenterHorizontally))
    ...
    item {
        ...
        AboutItem(
            "AWAiS - Buy me a coffee",
            stringResource(R.string.about_awais),
            "https://www.buymeacoffee.com/awaisome",
            {
                AsyncImage(
                    "https://www.buymeacoffee.com/icons/apple-icon.png",
                    "Awais Soomro",
        ...
        AboutItem(
            ...
            {
                AsyncImage(
                    "https://www.malariaconsortium.org/website-2013/images_social/mc-social.png",
                    "Malaria Consortium",
                    Modifier.size(64.dp).align(CenterVertically)
                )
            }
        ...
        AboutItem(
            ...
            {
                AsyncImage(
                    "https://assets-global.website-files.com/5f7c51bf9fac9b5ed62aa37b/5f80e009908a30089c390a64_Group%201%20(9).png",
                    "New Incentives",
                    Modifier.size(64.dp).align(CenterVertically)
                )
            }
...
) = OutlinedCard(Modifier.fillMaxWidth().padding(bottom = 8.dp).clickable { handler.openUri(link) }) {
